...
<div class="comments-count"><?php comments_number('No Responses Yet', '1 Response so far', '% Responses so far' );?></div>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="Post" align="left" />
